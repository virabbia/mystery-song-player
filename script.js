...
// Parse the URL fragment for the access token and log the full URL at the start
...
// Only clear the URL fragment if an access token is found
if (accessToken) {
...
console.log("Track URI outside function:", trackUri);
...
if (!accessToken) {
    ...
    console.log("Access token and track URI found. Setting up Play Song button...");
    // Spotify API code to play song once authenticated and track URI is found
